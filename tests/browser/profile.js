...
describe('In Profile page', () => {
    ...
    describe('when the page is loaded', () => {
        ...
        it('expect Profile Info button to show a button for changing password', () => {
            return async()
        ...
        it('expect Profile Info button to show user\'s phone and address', () => {
            return async()
                .then(() => ui.click('#btn-info'))
        ...
        it.skip('expect Add Pet button to show a form that enables user to add a pet', () => {
            return async()
